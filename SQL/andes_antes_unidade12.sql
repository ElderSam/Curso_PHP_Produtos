CREATE DATABASE IF NOT EXISTS `andes`;
USE `andes`;
/*
...
-- ----------------------------
BEGIN;
INSERT INTO `transportadoras` VALUES ('1', 'Rapidão Estrela', 'Rua Ernesto de Paula Santos, 187 ', '33262836', 'Recife', '17', '51.021-330', '2234234234'), ('2', 'Itapemirão', 'Rua Visconde de Sabugosa, 11', '33262836', 'São Paulo', '27', '01.323.123', '2424243221'), ('3', 'SEDEX', 'Av Ipanema, 22123', '33262836', 'Rio de Janeiro', '22', '02.320.121', '2342424324');
COMMIT;
